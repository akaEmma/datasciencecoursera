...
### Plot 3, the Global Active Power frequency histogram

plot(ourtime$timestamp,ourtime$Sub_metering_1, type="l", xlab="", ylab="Energy sub metering")
lines(ourtime$timestamp,ourtime$Sub_metering_2,col="red")
lines(ourtime$timestamp,ourtime$Sub_metering_3,col="blue")
